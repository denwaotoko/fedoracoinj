...
import com.google.fedoracoin.store.BlockStore;
import com.google.fedoracoin.store.BlockStoreException;
 ...
 * {@link com.google.fedoracoin.net.AbstractTimeoutHandler} and timeout is automatically disabled (using
 * {@link com.google.fedoracoin.net.AbstractTimeoutHandler#setTimeoutEnabled(boolean)}) once the version
...
public class Peer extends PeerSocketHandler {
    ...
    private static class GetDataRequest {
        ...
        // a nasty hack that relies on the fact that fedoracoin-qt is single threaded and processes messages in order.
     ...
     * {@link com.google.fedoracoin.net.NioClientManager#openConnection(java.net.SocketAddress, com.google.fedoracoin.net.StreamParser)}
     * or
     * {@link com.google.fedoracoin.net.NioClient#NioClient(java.net.SocketAddress, com.google.fedoracoin.net.StreamParser, int)}.</p>
     *
     ...
     * Once the pong is received the value returned by {@link com.google.fedoracoin.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link com.google.fedoracoin.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link com.google.fedoracoin.core.Peer#ping()} has never
