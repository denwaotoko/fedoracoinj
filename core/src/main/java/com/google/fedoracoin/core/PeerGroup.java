...
import com.google.fedoracoin.net.ClientConnectionManager;
import com.google.fedoracoin.net.NioClientManager;
import com.google.fedoracoin.net.discovery.PeerDiscovery;
import com.google.fedoracoin.net.discovery.PeerDiscoveryException;
import com.google.fedoracoin.params.MainNetParams;
import com.google.fedoracoin.script.Script;
import com.google.fedoracoin.utils.ExponentialBackoff;
...
public class PeerGroup extends AbstractExecutionThreadService implements TransactionBroadcaster {
    ...
    public void recalculateFastCatchupAndFilter(boolean forceFilterUpdate) {
        ...
        try {
            ...
            earliestKeyTimeSecs -= 86400 * 3; //TODO TIPS is still young, we can make it higher later. Makes blockchain sync way faster for new users.
     ...
     *         Use {@link com.google.fedoracoin.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link com.google.fedoracoin.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link com.google.fedoracoin.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link com.google.fedoracoin.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * times are available via {@link com.google.fedoracoin.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link com.google.fedoracoin.core.Peer#ping()}.
     */
