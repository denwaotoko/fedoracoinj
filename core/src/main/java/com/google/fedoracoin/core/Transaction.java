...
import com.google.fedoracoin.script.ScriptOpCodes;
...
public class Transaction extends ChildMessage implements Serializable {
     ...
     */
    public static final BigInteger MIN_NONDUST_OUTPUT = BigInteger.ONE; //TIPS: We can send one "shibetoshi" but this will cost us extra fee!

    // These are serialized in both fedoracoin and java serialization.
    ...
    /**
     * Same as {@link #addSignedInput(TransactionOutPoint, com.google.fedoracoin.script.Script, ECKey, com.google.fedoracoin.core.Transaction.SigHash, boolean)}
     ...
     * a wrapper around calling {@link Transaction#hashForSignature(int, byte[], com.google.fedoracoin.core.Transaction.SigHash, boolean)}
    ...
    public synchronized Sha256Hash hashForSignature(int inputIndex, byte[] connectedScript, byte sigHashType) {
        ...
        //
        //   https://en.fedoracoin.it/wiki/Contracts
