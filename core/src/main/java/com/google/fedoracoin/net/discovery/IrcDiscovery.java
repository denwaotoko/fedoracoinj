...
package com.google.fedoracoin.net.discovery;

import com.google.fedoracoin.core.AddressFormatException;
import com.google.fedoracoin.core.Base58;
...
public class IrcDiscovery implements PeerDiscovery {
     ...
     * disconnecting.
     *
     * @param channel The IRC channel to join, either "#fedoracoin" or "#bitcoinTEST3" for the production and test networks
     *                respectively.
     */
    public IrcDiscovery(String channel) {
        this(channel, "giraffe.heliacal.net", 6667);
    }
